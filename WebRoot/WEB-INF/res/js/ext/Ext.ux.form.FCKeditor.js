 ...
 * <script type="text/javascript" src="js/ext2/Ext.ux.form.FCKeditor.js"></script>
 * 
 * xtype : 'fckeditor'
 */
...
var oFCKeditorOptions = {   
    BasePath : parent.RES_PATH+'/fckeditor/',   
    Config : {   
        BaseHref : window.location,   
        SkinPath : parent.RES_PATH+'/fckeditor/editor/skins/silver/',   
