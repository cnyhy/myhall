...
p.i18n = {
  ...
  remove_btn_text: '删除',
  remove_btn_tip: '从上传队列移除文件.',
  reset_btn_text: '重置',
  reset_btn_tip: '重置队列.',
  upload_btn_start_text: '上传',
  upload_btn_stop_text: '中断',
  upload_btn_start_tip: '上传队列文件到服务器.',
  upload_btn_stop_tip: '停止上传.',
  close_btn_text: '关闭',
  close_btn_tip: '关闭对话框.',
  progress_waiting_text: '等待中...',
  progress_uploading_text: '上传: {1}　个文件中第　{0}　个传递完成.',
  error_msgbox_title: '错误',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: '选择的文件类型不允许.<br/>请选择以下的类型的上传文件: {1}',
  note_queued_to_upload: '排队等待上传.',
  note_processing: '正在上传...',
  note_upload_failed: '找不到服务器或服务器发生错误.',
