...
<html>
	...
	<body>
		<script type="text/javascript" src="${resRoot}/kindeditor-4.1.9/kindeditor-min.js"></script> 
		<script type="text/javascript" src="${resRoot}/kindeditor-4.1.9/lang/zh_CN.js"></script>
		<script type="text/javascript" src="${resRoot}/js/system/organManage.js"></script>
	</body>
</html>